...
def main():
    ...
    distances_part_two = [int(i) for i in re.findall(r"\d+", lines[1])]
    for time, distance in zip(times_part_one, distances_part_two):
    ...
    distance_part_two = int("".join([str(i) for i in distances_part_two]))
