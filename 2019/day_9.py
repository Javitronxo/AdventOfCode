...
def main():
    memory = utils.read_file_to_int_dict('day_9_input.txt')
    result_first_part = IntCodeProcessor(memory)
    result_first_part.add_input(1)
    print("First part result: {}".format(result_first_part.outputs))
    result_second_part = IntCodeProcessor(memory)
    result_second_part.add_input(2)
    print("Second part result: {}".format(result_second_part.outputs))
